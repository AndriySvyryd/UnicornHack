...
public class RectangleRangeTreeTest
{
    ...
    public void Simple()
    {
        ...
        var initialRectangles = new[]
        {
            ...
            new Rectangle(new Point(6, 7), new Point(10, 9)), new Rectangle(new Point(1, 3), new Point(3, 10)),
            ...
            new Rectangle(new Point(0, 0), new Point(10, 10)), new Rectangle(new Point(1, 1), new Point(8, 2)),
            new Rectangle(new Point(0, 5), new Point(9, 6)), new Rectangle(new Point(2, 7), new Point(10, 9)),
            new Rectangle(new Point(1, 4), new Point(2, 6)), new Rectangle(new Point(4, 1), new Point(5, 8)),
