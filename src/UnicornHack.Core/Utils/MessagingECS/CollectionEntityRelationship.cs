...
namespace UnicornHack.Utils.MessagingECS
{
        ...
        where TCollection : class, ICollection<TEntity>, new()
    {
        ...
        protected ICollectionAccessor<TEntity, TCollection, TEntity> Accessor { get; }
        protected Dictionary<int, HashSet<TEntity>> OrphanedEntities { get; } = new();
        ...
        public IReadOnlyCollection<TEntity> GetDependents(TEntity principal, Component removedComponent = null)
            => (IReadOnlyCollection<TEntity>)Accessor.GetDependents(principal, removedComponent) ?? Array.Empty<TEntity>();
