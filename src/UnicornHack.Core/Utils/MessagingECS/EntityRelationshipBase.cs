    ...
    IEntityRelationshipBase<TEntity> where TEntity : Entity, new()
{
    ...
    protected IEntityGroup<TEntity> PrincipalGroup
    {
        get;
    }

    protected IEntityGroup<TEntity> DependentGroup
    {
        get;
    }
    ...
    protected void HandlePrincipalEntityRemoved(TEntity dependentEntity,
        EntityChange<TEntity> principalEntityChange)
