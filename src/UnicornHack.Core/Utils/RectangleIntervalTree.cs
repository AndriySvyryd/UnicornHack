...
namespace UnicornHack.Utils
{
    public class RectangleIntervalTree
    {
        ...
        public Rectangle BoundingRectangle => new Rectangle(_xIntervalTree.BoundingSegment,
            _yIntervalTree.BoundingSegment);
        ...
        public IEnumerable<Rectangle> GetOverlapping(Rectangle rectangle)
            => _rectangleRangeTree.GetOverlappingCorners(rectangle)
