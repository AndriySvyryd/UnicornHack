...
namespace UnicornHack.Utils
{
        ...
        where T : IOwnerReferenceable
    {
        ...
        public ReferencingList() => _list = new List<T>();

        public ReferencingList(int capacity) => _list = new List<T>(capacity);

        public ReferencingList(IEnumerable<T> collection) => _list = new List<T>(collection);
