...
namespace UnicornHack.Data.Creatures
{
    ...
    {
        public static readonly CreatureVariant Warrior = new CreatureVariant
        {
            Name = "warrior",
            ...
            ValuedProperties = new Dictionary<string, object> {{"cold resistance", 3}, {"physical deflection", 10}},
            InitialLevel = 5,
