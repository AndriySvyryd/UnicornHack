...
namespace UnicornHack.Data.Creatures
{
    ...
    {
        public static readonly CreatureVariant MasterAssassin = new CreatureVariant
        {
            ...
            ValuedProperties = new Dictionary<string, object> {{"stealthiness", 3}, {"magic resistance", 30}},
            InitialLevel = 16,
