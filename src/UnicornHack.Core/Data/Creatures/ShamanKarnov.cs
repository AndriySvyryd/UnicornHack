...
namespace UnicornHack.Data.Creatures
{
    ...
    {
        public static readonly CreatureVariant ShamanKarnov = new CreatureVariant
        {
            Name = "Shaman Karnov",
            ...
            ValuedProperties = new Dictionary<string, object> {{"physical deflection", 10}, {"magic resistance", 30}},
            InitialLevel = 16,
