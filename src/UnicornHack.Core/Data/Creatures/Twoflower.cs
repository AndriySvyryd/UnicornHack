...
namespace UnicornHack.Data.Creatures
{
    ...
    {
        public static readonly CreatureVariant Twoflower = new CreatureVariant
        {
            Name = "Twoflower",
            ...
            ValuedProperties = new Dictionary<string, object> {{"physical deflection", 12}, {"magic resistance", 20}},
            InitialLevel = 16,
