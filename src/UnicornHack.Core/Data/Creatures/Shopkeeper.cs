...
namespace UnicornHack.Data.Creatures
{
    ...
    {
        public static readonly CreatureVariant Shopkeeper = new CreatureVariant
        {
            Name = "shopkeeper",
            ...
            SimpleProperties = new HashSet<string> {"sleep resistance", "infravisibility", "humanoidness"},
