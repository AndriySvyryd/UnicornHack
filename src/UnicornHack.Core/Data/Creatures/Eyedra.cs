    ...
    public static readonly Creature Eyedra = new Creature
    {
        ...
        Abilities = new HashSet<Ability>
        {
            ...
            new Ability
            {
                ...
                Cooldown = 350,
                Delay = "100*SpeedModifier()",
                Effects = new List<Effect> { new Slow { Duration = EffectDuration.UntilTimeout, DurationAmount = "13" } }
            },
            new Ability
            {
                Activation = ActivationType.Targeted,
                ...
                Cooldown = 350,
                Delay = "100*SpeedModifier()",
                Effects = new List<Effect> { new Sedate { Duration = EffectDuration.UntilTimeout, DurationAmount = "13" } }
            },
            new Ability
            {
                Activation = ActivationType.Targeted,
                ...
                Cooldown = 350,
                Delay = "100*SpeedModifier()",
                Effects = new List<Effect> { new Confuse { Duration = EffectDuration.UntilTimeout, DurationAmount = "13" } }
            },
            new Ability
            {
                Activation = ActivationType.Targeted,
