    ...
    public static readonly Creature Lemure = new Creature
    {
        ...
        Abilities = new HashSet<Ability>
        {
            new Ability
            {
                ...
                Effects = new List<Effect> { new Paralyze { Duration = EffectDuration.UntilTimeout, DurationAmount = "7" } }
            },
            new Ability
            {
                Activation = ActivationType.Targeted,
                ...
                Cooldown = 100,
                Delay = "100*SpeedModifier()",
                Effects = new List<Effect> { new Slow { Duration = EffectDuration.UntilTimeout, DurationAmount = "3" } }
            }
        },
        InitialLevel = 12,
