...
namespace UnicornHack.Services.LogEvents
{
    public readonly struct AttackEvent
    {
        ...
        public GameEntity AttackerEntity { get; }
        public GameEntity VictimEntity { get; }
        public SenseType AttackerSensed { get; }
        public SenseType VictimSensed { get; }
        public IReadOnlyList<GameEntity> AppliedEffects { get; }
        public AbilityAction AbilityAction { get; }
        public GameEntity WeaponEntity { get; }
