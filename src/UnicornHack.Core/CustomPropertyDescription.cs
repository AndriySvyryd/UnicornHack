...
namespace UnicornHack
{
    public class CustomPropertyDescription
    {
        ...
        public static CustomPropertyDescription Scavenging { get; } =
            new CustomPropertyDescription {PropertyType = typeof(bool)};

        public static CustomPropertyDescription Hematophagy { get; } =
            new CustomPropertyDescription {PropertyType = typeof(bool)};

        // TODO: Xylophagy, Geophagia
        ...
        public static CustomPropertyDescription MagicResistance { get; } =
            new CustomPropertyDescription {PropertyType = typeof(int), MinValue = 0, MaxValue = 100};
