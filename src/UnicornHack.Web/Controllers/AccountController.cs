...
using UnicornHack.Models.AccountViewModels;
...
namespace UnicornHack.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                await
                    _emailSender.SendEmailAsync(await _userManager.GetEmailAsync(user), subject: "Security Code",
                        message: message);
            }
        ...
        public async Task<IActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            ModelState.AddModelError(string.Empty, errorMessage: "Invalid code.");
            return View(model);
        }
